...
get_filename_component(_filename "/jetmax/src/jetmax_gazebo/jetmax_control/srv/IK.srv" NAME_WE)
add_custom_target(_jetmax_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jetmax_control" "/jetmax/src/jetmax_gazebo/jetmax_control/srv/IK.srv" ""
)

get_filename_component(_filename "/jetmax/src/jetmax_gazebo/jetmax_control/srv/FK.srv" NAME_WE)
add_custom_target(_jetmax_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "jetmax_control" "/jetmax/src/jetmax_gazebo/jetmax_control/srv/FK.srv" ""
)
